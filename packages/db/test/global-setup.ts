 ...
 * way to type the provide/inject channel; it augments the whole test tsc program. (ADR 0025)
 */
...
/**
 * Integration-test harness (ADR 0025 §11): start one ephemeral, prod-identical Postgres
