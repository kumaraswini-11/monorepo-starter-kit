/**
 * Brand icon (decorative). Paired with visible text ("Continue with Google"), so it is
 * `aria-hidden` — the button's text is the accessible name. `fill="currentColor"` + no
 * width/height so the caller sizes and colours it. Spread last so call sites can
 * override (size, `data-icon`, or `aria-*` for a rare meaningful use).
 */
