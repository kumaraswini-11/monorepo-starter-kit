...
supply-chain caution apply (see [0002](0002-proprietary-license-and-package-posture.md)).
...
- **Rejected for now:** the `skills.sh` registry / `npx skills add` (pulls unvetted
  ...
  (Agent-skills vendoring — which narrows and refines this rejection — is now
  [0010](0010-agent-skills-vendoring.md).)
...
[0011](0011-authentication-strategy.md)), we added a fifth server to `.mcp.json`:
...
- [0010](0010-agent-skills-vendoring.md) — agent skills, the sibling agent-config
  decision split out of this ADR.
- [0002](0002-proprietary-license-and-package-posture.md) — license & supply-chain
  posture that gates these choices.
- [0011](0011-authentication-strategy.md) — why the `better-auth` server was added.
